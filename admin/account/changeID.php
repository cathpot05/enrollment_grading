									...
									if(mysqli_num_rows($result)>0)
									{
										...
										?>
											<tr <?php if($row['ID']==$id){ echo "bgcolor=#ffe6e6"; }?>>
												...
												<td>
													<a href=approveRequest.php?id=<?php echo $id; ?>><button type="button" class="btn btn-primary btn-xs">Approve</button></a>
													<a href=rejectRequest.php?id=<?php echo $id; ?>><button type="button" class="btn btn-danger btn-xs" href=#>Reject</button></a>
												</td>
											</tr>
										<?php
										}
