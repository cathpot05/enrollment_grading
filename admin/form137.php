...
$sqlInfo = "SELECT B.*, E.schoolYear FROM student B
INNER JOIN enrolled_student A  ON A.student_ID = B.ID 
	...
	<table width=100% border=1 style="border-collapse: collapse;">
		...
		<tbody>
			...
			$sql = "SELECT G.subject,F.q1,F.q2,F.q3,F.q4, (F.q1+F.q2+F.q3+F.q4)/4 as finals 
					...
					INNER JOIN student H ON D.student_ID = H.ID
					WHERE H.ID = $id and B.ID = $ylID";
