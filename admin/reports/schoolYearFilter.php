    ...
    <div class="col-lg-12">
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-inline col-lg-4 cboLevel_container" >
                ...
                <div class="form-inline col-lg-4 cboSection_container">
                    <label>Section:</label>
                    <select class="form-control">
                        <option>Choose Grade Level First</option>
                    </select>
                </div>
            </div>

          <div class="panel-body">
              <div id="loadSectionData" class="loadSectionData">
