        ...
        ';
            ...
            if(mysqli_num_rows($result_section)>0)
            {
                while($row_section = mysqli_fetch_array($result_section))
                {
                    ...
                    echo '
                     <tr>
                        <td width="20%" ><input type="checkbox"  name="checklist_section[]" value="'.$row_section["ID"].'"/>
                        <input type=hidden class="form-control" name=chk__'.$row_section["ID"].' value="'.$row_section["section_ID"].'"/>
                        </td>
                        <td> '.$row_section["section"].'</td>
