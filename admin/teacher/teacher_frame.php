...
$sqlPrint = urlencode("Select employeeNo as Employee_No, CONCAT(Fname, ' ', Mname, ' ', Lname ) as Name, contactNo as Contact_No from teacher");
$header = urlencode("List of Teacher");
?>
<!DOCTYPE html>
<html>
	<head>
