    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
            ...
            <ul class="nav navbar-top-links navbar-right">
				...
				?>
					...
					<?php
					$sqlnotif = "Select teacher.Fname as TFname, teacher.Lname as TLname, student.Fname as SFname, student.Lname as SLname, grade_actions.actionType,grade_actions.status,grade_actions.Date, grade_actions.ID 
					FROM grade_actions
					INNER JOIN grade ON grade_actions.grade_ID = grade.ID 
					INNER JOIN teacher_section_subject ON grade.teacher_section_subject_ID = teacher_section_subject.ID
					INNER JOIN teacher ON teacher_section_subject.teacher_ID = teacher.ID
        ...
        <div id="page-wrapper">
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-10">
                    <h1 class="page-header">Year Level</h1>
                </div>
				<div class="col-lg-2">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="myModalLabel">Add New Year Level</h4>
                                        </div>
										<form role="form" action="addyearlevel.php" method=post>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover" id="dataTables-example">
									...
									$sql = "Select * from level ORDER BY level DESC";
									$result = mysqli_query($con,$sql);
									$stripe='odd';
									if(mysqli_num_rows($result)>0)
									{
	...
	function changeID(newID,type){
        var xhr;
			...
			xhr.onreadystatechange = function () {
                      ...
                      {
                         document.getElementById("delForm").action = "deleteLevel.php?delID="+xhr.responseText+"";
                     }
					 else if(type==='all')
                      {
