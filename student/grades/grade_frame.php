...
$sql = "Select section.year, section.section from enrolled_student 
...
$sqlAdmin = "Select *from student where ID=$studentID";
	...
	if(mysqli_num_rows($resultAdmin)>0)
	{
		...
		$sql2 = "INSERT INTO log(user,userType,logType) VALUES('$user','Student','Viewed his grade')";
...
<body>
    ...
    <div id="wrapper">
										...
										if(mysqli_num_rows($result)>0)
										{
											...
											while($row = mysqli_fetch_array($result))
											{
												...
												if(mysqli_num_rows($result2)>0)
												{
													...
													{
														?>
														<li class=<?php if($row2['ID']==$id){echo "selected";} ?>><a href="../grades/grade_frame.php?id=<?php echo $row2['ID'];?>">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row2['year']."-".$row2['section'] ;?></a></li>
														<?php
													}
												}
												?>
        ...
        <div id="page-wrapper">
                ...
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo $sectionName; ?> Subject Grades</h1>
                </div>
                <!--End Page Header -->
            </div>
            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover" id="dataTables-example">
									...
									$sql = "Select subject.subject, sy_section_subject.ID, teacher.Lname,teacher.Fname,teacher.Mname from sy_section_subject 
											...
											where enrolled_student.ID = $id AND enrolled_student.student_ID = $studentID";
									$result = mysqli_query($con,$sql);
									if(mysqli_num_rows($result)>0)
									{
										while($row = mysqli_fetch_array($result))
